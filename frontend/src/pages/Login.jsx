  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark">
      <div className="glass max-w-md w-full rounded-3xl p-12">
        <h1 className="text-4xl font-semibold text-center mb-10">Welcome back</h1>
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <input type="password" placeholder="Password" value={form.password} onChange={e => setForm({...form, password: e.target.value})}
                 className="w-full bg-transparent border border-black/200 rounded-3xl px-8 py-6 focus:outline-none focus:border-primary" />
          <button type="submit" className="w-full bg-primary text-black font-bold py-6 rounded-3xl text-lg border 1px hover:bg-black/30">
            Login
          </button>
        </form>
